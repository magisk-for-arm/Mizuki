...
- **西门飞雪线程**
作者已删帖，整合资源中含8Gen3/8E，可搭配Asoul使用（如有侵权可联系删除）。@小橙又沐风

### 6. GPU优化

- **降压**：用KonaBess软件导入“世眠保守2.1”降压配置（降低GPU功耗）游戏效果好一些，日常使用几乎没有区别

- 搭配GPU 762驱动，提升渲染效率。

- **甜馒头大佬**“强制Vulkan模块”，提升动画流畅度+降功耗，**骁龙865+以上机型适用**（部分机型易花屏）。
...
- **支付指纹修复模块**，root机可能导致无法使用微信指纹支付（解锁bootloader后soter损坏，导致微信指纹无法使用），可以用此模块来实现指纹支付(目前微信风控较严，建议暂时不要使用)
